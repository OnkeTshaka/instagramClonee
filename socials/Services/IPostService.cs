...
namespace socials.Services
{
    public class PostService : IPostService
    {
        ...
        /// <returns></returns>
        public async Task<List<Post>> GetTimelinePosts(string userName, ApplicationDbContext _ctx)
        {
        ...
        /// <param name="_ctx"></param>
        /// <returns></returns>
        public string SavePostMedia(string userName, Post post, HttpPostedFileBase imageFile, string uploadDirectory, ApplicationDbContext _ctx)
        {
        ...
        /// <param name="_ctx"></param>
        /// <returns></returns>
        public async Task<int> SavePost(string userName, string postMedia, Post post, ApplicationDbContext _ctx)
        {
    ...
    {
        Task<List<Post>> GetTimelinePosts(string userName, ApplicationDbContext _ctx);
        string SavePostMedia(string userName, Post post, HttpPostedFileBase imageFile, string uploadDirectory, ApplicationDbContext _ctx);
        Task<int> SavePost(string userName, string postMedia, Post post, ApplicationDbContext _ctx);
    }
}