...
namespace socials.Services
{
    public class FollowService : IFollowService
    {
        ...
        /// <returns></returns>
        public async Task<bool> Follow(string followerName, string followedName, ApplicationDbContext _ctx)
        {
        ...
        /// <param name="_ctx"></param>
        /// <returns></returns>
        public async Task<bool> Unfollow(string followerName, string followedName, ApplicationDbContext _ctx)
        {
        ...
        /// <param name="_ctx"></param>
        /// <returns></returns>
        public async Task<bool> IsFollowing(string followerName, string followedName, ApplicationDbContext _ctx)
        {
        ...
        /// <param name="_ctx"></param>
        /// <returns></returns>
        public async Task<int> FollowerCount(string userName, ApplicationDbContext _ctx)
        {
        ...
        /// <param name="_ctx"></param>
        /// <returns></returns>
        public async Task<int> FollowingCount(string userName, ApplicationDbContext _ctx)
        {
        ...
        /// <param name="_ctx"></param>
        /// <returns></returns>
        public async Task<List<ApplicationUser>> GetFollowers(string userName, ApplicationDbContext _ctx)
        {
        ...
        /// <param name="_ctx"></param>
        /// <returns></returns>
        public async Task<List<ApplicationUser>> GetFollowing(string userName, ApplicationDbContext _ctx)
        {
            return await _ctx.Following
    ...
    {
        Task<bool> Follow(string followerName, string followedName, ApplicationDbContext _ctx);
        Task<bool> Unfollow(string followerName, string followedName, ApplicationDbContext _ctx);
        Task<bool> IsFollowing(string followerName, string followedName, ApplicationDbContext _ctx);
        Task<int> FollowerCount(string userName, ApplicationDbContext _ctx);
        Task<int> FollowingCount(string userName, ApplicationDbContext _ctx);
        Task<List<ApplicationUser>> GetFollowers(string userName, ApplicationDbContext _ctx);
        Task<List<ApplicationUser>> GetFollowing(string userName, ApplicationDbContext _ctx);
    }
}